...
class Mailer {
                ...
                if (e instanceof multer.MulterError) {
                    if (req.body.clientLanguage == 'english') {
                        ...
                        sendmail("votre candidature doit être réintroduite Appliction", `Bonjour ${req.body.firstName + req.body.lastName}</h2>
                                    ...
                                    Nous sommes très intéressés par votre candidature, n'hésitez donc pas à en soumettre une autre.
                    ...
                    try {
                        ...
                        console.log(req.body.clientLanguage)
                        if (req.body.clientLanguage == 'english') {
                            ...
                            sendmail("Appliction confimation", `Bonjour ${req.body.firstName + req.body.lastName}</h2>
                                    ...
                                    <h4>Nous vous souhaitons beaucoup de joie</h4>`, [])
                        }
                        res.redirect('/')
    ...
    static orderMail = (req, res) => {
        Helper.handlingMyFunction(req, res, (req) => {
            sendmail("order from your site", ` <h2>order type:${req.body.requestType}</h2>
        ...
        <h2>other information:${req.body.otherInfo}</h2>`, [],"sthubert.taxicomp@gmail.com")
            if (req.body.clientLanguage == "french") {
                sendmail("confirmation de order", `
  ...
  <table style="border-collapse: collapse; width: 100%; max-width: 600px; margin: 0 auto;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="padding: 10px; border-bottom: 4px solid #000; text-align: left;">${req.body.requestType}</td>
      </tr>
      <tr>
                ...
                <table style="border-collapse: collapse; width: 100%; max-width: 600px; margin: 0 auto;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="padding: 10px; border-bottom: 4px solid #000; text-align: left;">${req.body.clientLanguage=="english"?req.body.requestType=='1'?"Order now":req.body.requestType==2?"Book for later":req.body.requestType=="3"?"Request information":"":req.body.requestType=="1"?'Commender pour maintenant':req.body.requestType=="2"?"Réserver pour après":req.body.requestType=="3"?"Demande de l'information":""}</td>req.body.requestType
                    </tr>
                    <tr>
