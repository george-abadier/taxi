...
class Mailer {
    ...
    static orderMail = (req, res) => {
        Helper.handlingMyFunction(req, res, (req) => {
            sendmail("order from your site", ` <h2>order type:${ req.body.clientLanguage == 'english' ? req.body.requestType == 'Commander pour maintenant' ? "Order For Now": req.body.requestType == 'Réserver pour après' ? "Book For Later" : "Request Information":req.body.requestType}</h2>
