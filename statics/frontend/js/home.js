...
var translateObject = {
  english: {
	...
	<br>- The largest fleet of minivans in the region: make your choice according to your needs.
	<br>- Online cab booking: in just a few clicks, order your cab using our mobile application. 
	<br>- Quick and easy payment: all our vehicles accept Interac direct payment cards. By opening a private or corporate account, you no longer need to pay each time you travel. The transportation service will be billed directly to your account. 
	<br>- Availability, speed and punctuality: trained and courteous, our drivers are available 24 hours a day, 7 days a week.
	<br>- Comfort and safety: all our vehicles are fully equipped to ensure the safety and comfort of our passengers. 
	
	<br><br>Want to know how much your trip will cost? Take a look at our rates page to calculate. 
	<br>Contact us today to find out more about our services or to book your cab.`,
  ...
  <br> - La plus grande flotte de minivans de la région : faîtes votre choix en fonction de vos besoins. 
  <br> - Réservation d’un taxi en ligne : en quelques clics seulement, commandez votre taxi grâce à notre application mobile. 
  <br> - Paiement simple et rapide : tous nos véhicules acceptent les cartes de paiement direct Interac. En ouvrant un compte privé ou corporatif, vous n’avez plus besoin de payer à chacun de vos déplacements. Le service de transport sera directement facturé sur votre compte. 
  <br> - Disponibilité, rapidité et ponctualité : formés et courtois, nos chauffeurs sont disponibles 24 heures sur 24 et 7 jours sur 7. 
  <br> - Confort et sécurité : tous nos véhicules sont dotés des équipements indispensables pour assurer la sécurité et le confort de nos passagers. 
  <br><br>Vous voulez prévoir le prix de votre déplacement? Jetez un coup d’œil à notre page tarifs pour en faire le calcul. 
  <br>Contactez-nous dès aujourd’hui pour en savoir plus sur nos services ou pour réserver votre taxi..`,
